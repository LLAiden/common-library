...
object DrawableUtil {
    ...
    fun getGradientDrawable(context: Context, @ColorRes color: Int, radius: Float, graph: Int = GradientDrawable.RECTANGLE): GradientDrawable {
    ...
    fun getGradientDrawable(context: Context, @ColorRes color: Int, @Size(4) radius: FloatArray, graph: Int = GradientDrawable.RECTANGLE): GradientDrawable {
        return getGradientDrawable(ContextCompat.getColor(context, color), radius, graph)
    }
