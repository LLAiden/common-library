...
object ColorUtil {
    ...
    fun alphaColor(context: Context, @ColorRes colorRes: Int, @IntRange(from = 0, to = 100) alpha: Int): Int {
        return alphaColor(ContextCompat.getColor(context, colorRes), alpha)
    }
